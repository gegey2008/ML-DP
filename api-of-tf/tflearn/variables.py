...
#Created Time: 2017-10-29 15:40:33
############################
...
def variable(name, shape=None, dtype=tf.float32, initializer=None,
            ...
            caching_device=None, validate_shape=True, dvice=None,
            restore=True):
    """ variable.
...
def get_inputs_placeholder_by_name(name):
    ...
    if len(vars) == 0:
        raise Exception("The collection `tf.GraphKeys.INPUTS` is empty! "
                        "Cannot retrieve palceholder. In case palceholder was "
